...
export default function userDetailsVerified() {
    ...
    <div className="flex flex-col min-h-screen">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <h2 className="text-xl font-semibold leading-[150%] text-[#121826] ">{userData.firstName} {userData.lastName}</h2>
            </button>
          </div>
          ...
          <div className="flex gap-3">
            ...
            <Button className="font-medium  text-[13px] leading-[150%] bg-[#039AE4]  text-[#FFFFFF]" >Save</Button>
          </div>
        </div>
      </div>
      ...
      <div className="container px-4  py-6 grid grid-cols-1  md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm">
          <div className="mb-6">
            <h3 className="text-lg font-bold  leading-[150%] text-[#1C1C1C]">Personal Details</h3>
            <p className="text-sm text-[#5C5C5C] leading-[22px]">Manage User's Information</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-6">
            <div>
              <label className="block text-[16px] font-medium text-[#1C1C1C] leading-[100%] mb-1">Last Name</label>
            ...
            <div>
            <label className="block text-[16px] font-medium text-[#1C1C1C] leading-[100%] mb-1">First Name</label>
            ...
            <div>
            <label className="block text-[16px] font-medium text-[#1C1C1C] leading-[100%] mb-1">Email</label>
            ...
            <div>
            <label className="block text-[16px] font-medium text-[#1C1C1C] leading-[100%] mb-1">Phone Number</label>
            ...
            <div>
            <label className="block text-[16px] font-medium text-[#1C1C1C] leading-[100%] mb-1">Date Of Birth</label>
            ...
            <div>
            <label className="block text-[16px] font-medium text-[#1C1C1C] leading-[100%] mb-1">Gender</label>
            ...
            <div>
            <label className="block text-[16px] font-medium text-[#1C1C1C] leading-[100%] mb-1">Nationality</label>
            ...
            <div>
            <label className="block text-[16px] font-medium text-[#1C1C1C] leading-[100%] mb-1">Occupation</label>
              <input value={userData.occupation} 
              type="text"
              placeholder="student"
                 className="xl:w-[230px] w-[100px] h-[30px] leading-[27px] mt-0 text-[16px] xl:h-[60px] xl:text-[18px] text-[#121826] bg-[#f5f5f5f5] border-none rounded-sm p-2 focus:outline-none font-bold font-Inter xl:leading-[34.5px]"/>
            </div>
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm">
          <div className="mb-6">
          <h3 className="text-lg font-bold  leading-[150%] text-[#1C1C1C]">ID Card Information</h3>
          <p className="text-sm text-[#5C5C5C] leading-[22px]">Manage User's Information</p>
          </div>
