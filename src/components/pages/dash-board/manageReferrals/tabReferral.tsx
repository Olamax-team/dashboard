...
import ManageReferralHistory from "./manageReferralHistory";


const TabReferral = () => {
  const [activeTab, setActiveTab] = useState("manage Referral");
  ...
  const tabs = [
    { id: "manage Referral", label: "Manage Referral" },
  ...
  const renderComponent = () => {
    switch (activeTab) {
     case "manage Referral":
        return <ManageReferralHistory  visibleFilter={visibleFilter}/>;

        case "bonus History":
            return <BonusHistory visibleFilter={visibleFilter}/>;
      default:
    ...
    <div className="flex items-center justify-between  h-auto  mb-5 w-full flex-wrap">
      ...
      <div className="flex items-center justify-center ml-3 lg:ml-0 mt-5 lg:mt-0 gap-5">
       ...
       <div className="relative">
        <div className="flex items-center p-3 gap-1 cursor-pointer" onClick={toggleDropdown}>
