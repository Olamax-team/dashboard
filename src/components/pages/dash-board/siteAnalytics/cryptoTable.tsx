    ...
    <Card className="w-full shadow-sm">
      <div className="flex flex-col lg:flex-row gap-5">
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-muted/50">
                  <TableHead className="font-bold text-[12px] text-[#121826]">
                    Crypto
                  </TableHead>
                  <TableHead className="font-bold text-[12px] text-[#121826]">
                    Total Monthly Sales
              ...
              <TableBody>
                {transactionData.map((row, index) => (
                  <TableRow key={index}>
                    <TableCell>
                      <div className="font-medium text-[12px] text-[#121826]">
                        {row.cryptoCode}
                      </div>
                      <div className="text-[10px] text-[#121826]">
                        {row.crypto}
                      </div>
                    </TableCell>
                    <TableCell className="font-medium text-[12px] text-[#121826]">
                      {row.totalMonthlySales}
                    </TableCell>
                    <TableCell className="font-medium text-[12px] text-[#121826]">
                      {row.totalAirtimePurchase}
                    </TableCell>
                    <TableCell className="font-medium text-[12px] text-[#121826]">
                      {row.totalDataPurchase}
                    </TableCell>
                    <TableCell className="font-medium text-[12px] text-[#121826]">
                      {row.totalBillPayment}
                    </TableCell>
                  </TableRow>
                ))}
              </TableBody>
        ...
        <div className="w-full lg:w-[40%] h-auto p-4 bg-white  rounded-lg">
          <h2 className="lg:text-[16px] font-bold text-[14px] text-[#141414]">
            Popular Top-Up & Bills
          </h2>
          ...
          <div className="space-y-4 mt-5">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-[14px] text-[#121826]">
                    USDT/NGN
                  </p>
                  <p className="text-[10px] font-medium text-[#121826]">
                    Tether
                  </p>
                </div>
              </div>
              <span className="text-[#121826] font-medium text-[14px]">
                Airtime
              </span>
            </div>
