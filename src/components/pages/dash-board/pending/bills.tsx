...
const Bills = () => {
  ...
  const pendingBills = fullData?.data.bills;
  ...
  if (status === 'success' && pendingBills && pendingBills.length < 1) {
    return (
      <div className="w-full h-[40vh] flex justify-center py-20">
  ...
  if (status === 'success' && pendingBills && pendingBills.length > 0) {
    return (
      <React.Fragment>
        <div className="mx-auto px-3 py-2">
          <Table className="border-collapse border-2">
            ...
            <TableBody>
              {pendingBills && pendingBills.length > 0 && pendingBills.map((transaction) => (
                <TableRow
